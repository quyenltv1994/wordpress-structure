...
?>
    ...
    <section class="bg-gray-7">
        <div class="breadcrumbs-custom box-transform-wrap context-dark">
            <div class="container">
                <h3 class="breadcrumbs-custom-title"><?=get_the_title()?></h3>
                <div class="breadcrumbs-custom-decor"></div>
            </div>
            <div class="box-transform" style="background-image: url(<?= ASSETS_PATH ?>/images/bg-breadcrumbs.jpg);"></div>
        </div>
        <div class="container">
                            ...
                            <div class="col-md-6">
                                <div class="form-wrap">
                                    ...
                                    <select class="form-input" data-minimum-results-for-search="Infinity" data-constraints="@Required">
                                        ...
                                        <option value="3">Floor Repair</option>
                                        <option value="4">Floor Care</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
